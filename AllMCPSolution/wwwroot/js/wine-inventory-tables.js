...
window.WineInventoryTables.initialize = function () {
            ...
            function bindDetailAddRow() {
                ...
                // Capture phase listener to record the element stack even if the click is swallowed later
                detailAddButton.addEventListener('pointerdown', (event) => {
                    if (typeof window !== 'undefined' && window.console && typeof window.console.log === 'function') {
                        window.console.log('[BottleManagementModal] Add Bottles pointerdown', {
                            buttonDisabled: detailAddButton.disabled,
                ...
                detailAddButton.addEventListener('mousedown', () => {
