...
public class GetArtworkSalesHammerPerAreaTool : IToolBase
{
    ...
    public GetArtworkSalesHammerPerAreaTool(ApplicationDbContext dbContext, IInflationService inflationService)
    {
    ...
    public async Task<object> ExecuteAsync(Dictionary<string, object>? parameters)
    {
        ...
        foreach (var s in sales)
        {
            ...
            var adjPrice = await _inflationService.AdjustAmountAsync(s.HammerPrice, s.SaleDate);
